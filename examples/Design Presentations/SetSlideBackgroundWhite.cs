...
class Program
{
    static void Main()
    {
        ...
        presentation.Slides[0].Background.FillFormat.SolidFillColor.Color = System.Drawing.Color.White;

        // Save the presentation
        presentation.Save("SlideBackgroundWhite.pptx", Aspose.Slides.Export.SaveFormat.Pptx);
    }
}